...
var rollStats = function() {
    ...
    $("str").value = diceRoll(6)+diceRoll(6)+diceRoll(6)+diceRoll(6);
    $("dex").value = diceRoll(6)+diceRoll(6)+diceRoll(6)+diceRoll(6);
    $("cons").value = diceRoll(6)+diceRoll(6)+diceRoll(6)+diceRoll(6);
    $("int").value = diceRoll(6)+diceRoll(6)+diceRoll(6)+diceRoll(6);
    $("wis").value = diceRoll(6)+diceRoll(6)+diceRoll(6)+diceRoll(6);
